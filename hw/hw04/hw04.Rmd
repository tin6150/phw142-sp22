...
_due 02-22 late cuz of midterm, but not graded anyway_ 

//sn50//  better off save file as hw04sn50.Rmd and leave it in main instead of branching
// the sync will eventually make me get into conflict and stuff...
simulation... prob...
my notes from wk5Adon't have lots of R fn... 
wtf?
...
pnorm(q=253,mean=145,sd=36,lower.tail=T)

pnorm(q=253,mean=145,sd=36,lower.tail=F)
```

# quiz04 in wk6
sensitivity : P(T+|D+) : 245/310 = 79.03%
specificity : P(T-|D-) : 879/959 = 91.66%
NPV : P(D-|T-) : 879/944 = 93.11%
PPV : P(D+|T+) : 245/325 = 75.38%
...
### Instructions 
* Solutions will be released on _Tuesday, February 22nd._
...
_what does table has to do with this answer??!!_
_wasn't this a code problem?  why prose answer??!!_
cuz table  is what they mean by "probability model" *sigh* 
...
#sim_01 = rnorm(n=200, meean=0)  ## no, mean and sd not provided.  NOT normal dist, binomial!  wk6 material!  never mind it says hw04.... and assigned last week?!?! *sigh*

birth_id = 1:200
bd = c( rep(1,ceiling(200*.3030)), rep(0,200*.6970))
bd
...
## need to setwd("~/tin-gh/phw142-sp22/hw/hw04")
## before autograder works?!
## can't get wombat Rstudio to work... 
## so have to use datahub...
```
