...
n_grp0    <- deeks1 %>% filter(Age==0) %>% nrow()
n_grp1    <- deeks1 %>% filter(Age==1) %>% nrow()
...
pvalue_deeks_R <-   t.test(ave_cd4 ~ AgeGrp, alternative="two.sided" , data=deeks1)
#pvalue_deeks_R <-   t.test(ave_cd4 ~ AgeGrp, paired=TRUE , data=deeks1)
pvalue_deeks_R
